...
import { surveyContent } from "./content/survey";
import { evaluasiContent } from "./content/evaluasi";
import { budayaContent } from "./content/budaya";
import { timContent } from "./content/tim";
import { dokumenContent } from "./content/dokumen";
import TimContent from "./components/TimContent";
import DokumenContent from "./components/DokumenContent";
import EvaluasiContent from "./components/EvaluasiContent";
...
export default function ManajemenPerubahan() {
  ...
  const contentMap = {
    ...
    evaluasi: evaluasiContent,
    budaya: budayaContent,
    tim: timContent,
    dokumen: dokumenContent
  };

  const currentContent = contentMap[activeMenu] || programContent;

  // Fungsi render konten dinamis
  const renderContent = () => {
    switch (activeMenu) {
      case "tim":
        return <TimContent content={currentContent} />;
      
      case "dokumen":
        return <DokumenContent content={currentContent} />;

      case "evaluasi":
        return <EvaluasiContent content={currentContent} />;

      case "program":
        return <ProgramContent content={currentContent} />;

      case "survey":
        return <SurveyContent content={currentContent} />;

       case "budaya":
        return <BudayaContent content={currentContent} />;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg lg:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Transformasi organisasi menuju birokrasi yang bersih, akuntabel, dan melayani
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:w-1/4">
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
                  <h2 className="text-xl font-bold text-gray-800">Manajemen Perubahan</h2>
