...
import { sertifikasiContent } from "./content/sertifikasi";
import { bisnisprosesContent } from "./content/bisnisproses";
import SertifikasiContent from "./components/SertifikasiContent";
import BisnisprosesContent from "./components/BisnisprosesContent";

export default function ManajemenMutu() {
  const [activeMenu, setActiveMenu] = useState("sertifikasi");

  const contentMap = {
    sertifikasi: sertifikasiContent,
    bisnisproses: bisnisprosesContent
  };

  const currentContent = contentMap[activeMenu] || sertifikasiContent;

  // Fungsi render konten dinamis
  const renderContent = () => {
    switch (activeMenu) {
      case "sertifikasi":
        return <SertifikasiContent content={currentContent} />;

      case "bisnisproses":
        return <BisnisprosesContent content={currentContent} />;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg lg:text-xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Meningkatkan kualitas pelayanan melalui sistem manajemen mutu yang terintegrasi
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:w-1/4">
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
                <div className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-200">
                  <h2 className="text-xl font-bold text-gray-800">Manajemen Mutu</h2>
